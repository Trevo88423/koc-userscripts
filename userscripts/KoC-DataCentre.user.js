...
(async function() {
  ...
  const SCRIPT_VERSION = '2.23.0'; // Must match @version above
  ...
  const FEATURE_STEPS = [
    ...
    { f: 'inactives-collector', label: 'collectFromInactives', when: () => onPage("inactives.php"), run: () => collectFromInactives() },
